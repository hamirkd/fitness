export class Client {
    ...
    datenais:any;
    observation:any;
    typeclient:'FONCTIONNAIRE_ISSP'|'FONCTIONNAIRE_UJKZ'|'FONCTIONNAIRE'|'FONCTIONNAIRE_ENSEIGNANT_CHERCHEUR'|'CONTRACTUELS_ISSP'|'CONTRACTUELS_UJKZ'|'ASSISTANTS_RECHERCHE';
