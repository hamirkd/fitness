...
@Component({
    selector: 'app-nouveau-abonnement',
    templateUrl: './nouveau-abonnement.component.html',
    styleUrls: ['./nouveau-abonnement.component.scss'],
})
export class NouveauAbonnementComponent implements OnInit {
    constructor(
    ...
    annuler(element: Abonnement) {
        ...
        this.dialogRef.afterClosed().subscribe((response: any) => {
            ...
            this._abonnementService.cancelle(response).subscribe(
                (d) => {
                    this._updateDataSource();
                    console.log(d);
                },
    ...
    supprimer(element: Abonnement) {
        this.dialogRef = this._fuseConfirmationService.open({
            title: 'Suppression de la abonnement',
            message:
                'Voulez-vous supprimer la abonnement N ' + element.id + ' ?',
        });
        console.log(this.user);
    ...
    generer() {
        this.dialogRef = this._fuseConfirmationService.open({
            title: 'Voulez vous générer les abonnements',
            message:
                'Voulez-vous générer les abonnements de la période '
    ...
    regenerer() {
        this.dialogRef = this._fuseConfirmationService.open({
            title: 'Voulez vous générer les abonnements',
            message:
                'Voulez-vous supprimer et recréer les abonnements de la période '
                + this.mois + ' ' + this.annee + ' ?',
        });
